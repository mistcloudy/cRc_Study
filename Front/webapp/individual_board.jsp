          ...
          <div class="col-lg-2">
           <c:set var="i" value="${info }"/>
            <div class="card mb-3" style="margin-top:100px;">
              ...
              <img alt="" src="upload/${i.board_t_image }" style="height:150px;width:100%">
              <div class="card-body">
              </div>
              <div class="card-body">
            ...
            <form action="favoriteCheck.oshi?fav_board=${board_type}&fav_user=${sessionScope.member_code}" method="post">
            <button type="submit" class="btn btn-secondary btn-lg" style="margin-top: 50px;">즐겨 찾기</button>
            <input type="hidden" value="${i.board_t_code}" name="board_t_code">
         <input type="hidden" value="${sessionScope.member_code}" name="member_code">
            </form>
          </div>
            ...
            <div class="container">
                ...
                <!-- 데일리베스트 -->
                  <div class="col-lg-6" style="margin-top: 20px;">
                      <table class="table table-bordered" style="text-align: center;">
                          <tr class="table-warning"><th style="text-align: center;">일간인기게시물</tr>
                             <tbody>
                              <c:forEach var="a" items="${daily }">
                                 <tr>
                                    <td><a href="individual_read.oshi?board_type=${a.board_type}&board_no=${a.board_no}" style="text-decoration: none;">${a.board_title}</a></td>
                                 </tr>
                           </c:forEach>
                     </tbody>
                      </table>
                  ...
                  <div class="col-lg-6" style="margin-top: 20px;">
                      <table class="table table-bordered" style="text-align: center;"> 
                          <tr class="table-warning"><th style="text-align: center;">주간인기게시물</tr>
                             <tbody>
                               <c:forEach var="b" items="${weekly }">
                                 <tr>
                                    <td><a href="individual_read.oshi?board_type=${b.board_type}&board_no=${b.board_no}" style="text-decoration: none;">${b.board_title}</a></td>
                                 </tr>
                              </c:forEach>
                        </tbody>
                      </table>
              ...
              <div>
                  <table class="table table-bordered">
                      ...
                      <tr class="table-active">
                          <td colspan="11" style="text-align:center">등록된 글이 없습니다.</td>
                      </tr>
              			</c:if>
                      ...
                      <tr class="table-active">
                          ...
                          <td style= "width:150px;" colspan="5"  ><a href="individual_read.oshi?board_type=${n.board_type}&board_no=${n.board_no}" style="text-decoration: none">${n.board_title}</a></td>
              ...
              <!-- 페이징 -->
	               ...
	               <c:set var="endPage" value="${pageCount }" />
	                  ...
	                  <ul class="pagination">
	                    ...
	                    <li class="page-item">
	                      ...
	                      <a class="page-link" href="individual_board.oshi?board_type=${board_type}&find_box=${find_box}&find=${find}&pageNum=${i}" >${i}</a>
	                    ...
	                    <li class="page-item">
	                    <c:if test="${endPage < pageCount }">
	                      <a class="page-link" href="individual_board.oshi?board_type=${board_type}&find_box=${find_box}&find=${find}&pageNum=${startPage + pageBlock}">&raquo;</a>
	                      </c:if>
	                    </li>
	                  </ul>
                  </c:if>
                ...
                <div>
                  ...
                  <form action="" method="post" name="find_frm">
                   <input type="hidden" name="find_box" value="${find_box }">
                 <input type="hidden" name="find" value="${find }">
                    </form>
                    <form action="individual_board.oshi?board_type=${board_type}&board_no=${article.board_no}&pageNum=${currentPage}"  method="post" name="find_frm"
              ...
              <div class="col-lg-12" style="text-align: center;">
                <span><input type="button" class="btn btn-outline-info" style="width: 150px; height: 50px;" value="글쓰기" onclick="window.location='individual_write.oshi?board_type=${board_type}'"></span>
                <span><input type="button" class="btn btn-outline-info" style="width: 150px; height: 50px;" value="개념글 보기" onclick="window.location='individual_best_board.oshi?board_type=${board_type}'"></span>
