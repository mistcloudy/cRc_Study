...
<html lang="en">
  ...
  <body>
     <div class="container">
        ...
        <div class="col-lg-6">
        <form action="memberModifyProc.oshi" method="post">
          <fieldset>
            <legend style="text-align: center;">회원 정보 수정</legend>
            <div class="form-group">
              <fieldset disabled="">
                <label class="control-label" for="disabledInput">아이디</label>
                <input name="member_id" class="form-control" id="disabledInput" type="text" placeholder="id" disabled="disabled" value="${vo.member_id }">
              </fieldset>
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">비밀번호</label>
              <input name="member_password" type="password" class="form-control" id="exampleInputPassword" placeholder="Enter Password" value="${vo.member_password }">
            </div>
            <div class="form-group">
              <label for="exampleInputNickname">닉네임</label>
              <input name="member_nickname" type="text" class="form-control" id="exampleInputNickname" placeholder="Enter Nickname" value="${vo.member_nickname }">
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Email</label>
              <input name="member_email" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" value="${vo.member_email }">
            </div>
            <div style="text-align: center;">
            <button type="submit" class="btn btn-primary" style="width:100px;">정보 수정</button>
