      ...
      <div class="container">
        ...
        <div class="container">
          ...
          <div class="col-lg-10">
            ...
            <form action="writeProc.oshi?board_type=${board_type}" method="post" name="writeForm" onsubmit="return writeSave()">                
                    ...
                    <tr class="table-info">
                        <th>
                            <select class="btn-info" name="Board_category">
                              ...
                              <option value="BC03" selected>잡담</option>
                              <option value="BC04">이벤트</option>
                              <c:if test="${vo.member_code == info.board_t_manager}">
                              <option value="BC01">공지</option>
                              </c:if>
                            </select>
                        </th>
                        <th colspan="10" style="text-align: center; vertical-align: middle;"><input type="text" size="130" name="Board_title"></th>
                    </tr>
                    <tr>
                      <td colspan="11"><textarea name="Board_content" id="" cols="150" rows="30"></textarea></td>
                  </tr>
                  <tr>
                      <td colspan="11">
                        <div class="form-group">
            ...
            <div class="col-lg-12">
                ...
                <input type="button" class="btn btn-outline-info" value="목록" style="width: 100px;" onclick="window.location='individual_board.oshi'">
            </div>
        </div>
