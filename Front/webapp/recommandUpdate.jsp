      ...
      <div class="container">
        ...
        <div class="col-lg-10">
          <div class="col-lg-10 col-md-10">
            <div>
                <form action="recommandUpdateProc.oshi?board_no=${board_no}" method="post" name="writeForm" onsubmit="return writeSave()">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td colspan="9" style="text-align: center; vertical-align: middle;" ><input type="text" size="120" name="url_path" value="${url}"></td>
                    </tr>
                    <tr class="table-info">
                        <td colspan="11" style="text-align: center;">곡소개 및 추천이유</td>
                    </tr>
                    <tr>
                        <td colspan="11"><textarea name="board_content" cols="150" rows="15">${board_content}</textarea></td>
                    </tr>
                    
                 	 <tr>
                  		<td colspan="11">
                	  		<input type="submit" class="btn btn-outline-info" value="글수정" style="width: 100px;">
            		 		<input type="reset" class="btn btn-outline-info" value="취소" style="width: 100px;">
