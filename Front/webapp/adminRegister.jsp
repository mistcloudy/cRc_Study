              ...
              <div>
                  <table class="table table-bordered">
                      <tr class="table-info">
                          ...
                          <th style="text-align: center;">관리자 신청자 코드</th>
                          <th style="text-align: center;">결정하기</th>
                          <th style="text-align: center;">승인여부(승인:1)</th>
                          
                      </tr>
                      
                       <c:forEach var="a" items="${getAdminRegisterInfo}">
                      <tr>
                          <td>${a.admin_r_no}</td>
                          ...
                          <td>
		                     ...
		                     <form action="/Oshi/adminRegisterProc.oshi?board_t_name=${a.admin_r_board}&admin_r_requester=${a.admin_r_requester}" method="post" name="info"
