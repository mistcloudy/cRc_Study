      ...
      <div class="container">
        ...
        <div class="container">
          ...
          <div class="col-lg-10">
            ...
            <form action="NoticeWriteProc.oshi?board_type=A00" method="post" name="writeForm" onsubmit="return writeSave()">                
            ...
            <div class="col-lg-12">
                ...
                <input type="button" class="btn btn-outline-info" value="목록" style="width: 100px;" onclick="window.location='NoticeList.oshi'">
            </div>
        </div>
