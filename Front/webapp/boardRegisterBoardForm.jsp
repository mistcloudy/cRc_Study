                  ...
                  <table class="table table-bordered">
                      ...
                      <tr>
                          ...
                          <td colspan="4" style="width: 35%;">
                          	<input type="text" size="50" name="board_r_url">
                          </td>                     
                      ...
                      <tr>
                          <td colspan="11" style="text-align: center;">
                          	<textarea id="" cols="150" rows="15" name="board_r_profile_desc"></textarea>
                          </td>
                      </tr>
                      <tr class="table-info">
                      ...
                      <tr>
                          <td colspan="11" style="text-align: center;">
                          	<textarea  id="" cols="150" rows="15" name="board_r_content"></textarea>
                          </td>
                      </tr>
